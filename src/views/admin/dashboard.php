    ...
    <section class="admin-contenido">
        <div class="dos-columnas-admin">
            <div class="tabla-card" style="padding: 28px;">
                ...
                <a href="admin/productos" class="boton principal">Ver listado de productos</a>
            </div>

            <div class="tabla-card" style="padding: 28px;">
                <h3 style="margin-bottom: 6px;">Acciones rápidas</h3>
                <p style="color: #8a735f; margin: 0 0 18px;">Ir directo a lo más habitual</p>
                <a href="admin/productos/crear" class="boton secundario bloque" style="margin-bottom: 12px;">+ Añadir producto</a>
                <a href="admin/productos" class="boton cancelar bloque">Ver listado</a>
            </div>
        </div>
    </section>
</main>
